  ...
  return (
    <div className="home2-e-28" data-cdhs="up">
        <div className="home2-e-29">
            <div className="home2-e-41"> <Text tag="span" className="home2-e-40"> <Image src="https://assets-v2.codedesign.ai/storage/v1/object/public/68d9ba37be7e5676b63a52e3_d9e7f34a/asset-5de5ac27" alt="Image" /> </Text>
